...
import ShopList from "./AddNewRelationship";
...
function SalesExecutive () {
    ...
    return (
        ...
        <div className="mt-20">
        <div className="m-3">
        <div className="bg-white shadow-lg dark:text-gray-200 dark:bg-secondary-dark-bg  mt-4 rounded md:w-full  ">
            <section class="bg-white rounded p-3 dark:bg-gray-900">
  {/* <div class=" px-4  ">
      ...
      <form action="#">
          ...
          <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-dark bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
              Add product
          </button>
      </form>
  </div> */}
